 ...
 *  © 2020 All Rights Reserved By  Soft.
 *
 */
(function (e) {
  e.fn.vsmobilemenu = function (n) {
    ...
    return this.each(function () {
      function n(n) {
        ...
        l.hasClass(s.subMenuToggleClass) &&
          (l.removeClass(s.subMenuToggleClass),
          l.slideUp(s.toggleSpeed),
          l.parent().removeClass(s.subMenuParentToggle));
      }

      function l(l) {
        e(l).next("ul").length > 0
          ? (e(l).parent().toggleClass(s.subMenuParentToggle),
            e(l).next("ul").slideToggle(s.toggleSpeed),
            e(l).next("ul").toggleClass(s.subMenuToggleClass),
            n(l))
          : e(l).prev("ul").length > 0 &&
            (e(l).parent().toggleClass(s.subMenuParentToggle),
            e(l).prev("ul").slideToggle(s.toggleSpeed),
            e(l).prev("ul").toggleClass(s.subMenuToggleClass),
            n(l));
      }
      ...
      function o() {
        i < s.expandScreenWidth
          ...
          : (g.css("display", ""),
            e(s.menuContainer).css("display", "none"),
            e(s.menuBody).css("display", "none"));
      }
      var t = e(this).html();
      ...
      e(u).each(function () {
        ...
        e(s.menuBody).length > 0 &&
          e(s.menuBody).on("click", function (n) {
            n.stopPropagation(),
              e(s.menuBody).hasClass(s.bodyToggleClass) &&
                (e(s.menuBody).removeClass(s.bodyToggleClass),
                e(s.menuContainer).removeClass(s.menuToggleClass),
                e(s.menuToggleBtn).removeClass(s.btnToggleClass));
          }),
        e(s.menuBody)
          .find("div")
          .on("click", function (e) {
