...
<head>
    ...
    <title>FeeTech - Organic Food Store HTML Template - Login & Register</title>
                                        ...
                                        <div class="login-register-wrapper">
                                            <div class="tab-btn mb-20">
                                                <ul class="nav nav-tabs login-tab" permissions="tablist">
                                                    <li class="nav-item" data-tab-select="login"><button
                                                            class="nav-link active" id="login-tab" data-bs-toggle="tab"
                                                            data-bs-target="#login" permissions="tab" aria-controls="login"
                                                            aria-selected="true">Log In</button></li>
                                                    <li class="nav-item" data-tab-select="register"><button
                                                            class="nav-link" id="register-tab" data-bs-toggle="tab"
                                                            data-bs-target="#register" permissions="tab"
                                                            aria-controls="register"
                                                            aria-selected="false">Register</button></li>
                                                </ul>
                                            </div>
                                            <div class="tab-content">
                                                <div class="tab-pane fade active show" data-tab="login" id="login"
                                                    aria-labelledby="login-tab">
                                                    <form method="post" class="woocommerce-form login">
                                                        <p class="form-group"><input name="username"
                                                                class="form-control border" type="text"
                                                                placeholder="User Name"></p>
                                                        <p class="form-group"><input class="form-control border"
                                                                name="password" type="password" placeholder="Password">
                                                        </p>
                                                        <p class="custom-checkbox notice"><input id="remember"
                                                                value="forever" name="rememberme" type="checkbox"><label
                                                                for="remember">Remember me<span
                                                                    class="checkmark"></span></label></p>
                                                        <p class="form-group"><button type="submit"
                                                                class="vs-btn">Login</button></p>
                                                        <p><a href="#" class="btn-inline">Forgot Your Password?</a></p>
                                                    </form>
                                                </div>
                                                <div class="tab-pane fade" data-tab="register" id="register"
                                                    aria-labelledby="register-tab">
                                                    <form method="post" class="woocommerce-form register">
                                                        <p class="form-group"><input name="email" class="form-control"
                                                                type="email" placeholder="Email"></p>
                                                        <p class="form-group"><input name="password"
                                                                class="form-control" type="password"
                                                                placeholder="Password"></p>
                                                        <div class="user-permissions mt-40">
                                                            <div class="custom-checkbox">
                                                                <input id="customer" type="radio" name="permissions"
                                                                    value="customer" checked="checked">
                                                                <label for="customer" class="radio">I am a customer
                                                                    <span class="checkmark"></span></label>
                                                            </div>
                                                            <div class="custom-checkbox">
                                                                <input id="seller" type="radio" name="permissions"
                                                                    value="seller">
                                                                <label for="seller" class="radio">I am a vendor <span
                                                        ...
                                                        <div>
                                                            <p>Your personal data will be used to support your
                                                                ...
                                                                your account, and for other purposes described in our <a
                                                                    href="#">privacy policy</a>.</p>
                                                        </div>
                                                        <p class="form-group mt-40"><button type="submit"
                                                                class="vs-btn">Register</button></p>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
