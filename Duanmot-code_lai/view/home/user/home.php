<h1>User Home</h1><!DOCTYPE html>
<html class="no-js" lang="zxx" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>FeeTech - Organic Food Store HTML Template - Home One</title>
    <meta name="author" content="" />
    <meta
      name="description"
      content="FeeTech - Organic Food Store HTML Template"
    />
    <meta
      name="keywords"
      content="FeeTech - Organic Food Store HTML Template"
    ...
    <link
      ...
      sizes="57x57"
      href="./src/assets/img/favicons/apple-icon-57x57.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="60x60"
      href="./src/assets/img/favicons/apple-icon-60x60.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="72x72"
      href="./src/assets/img/favicons/apple-icon-72x72.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="76x76"
      href="./src/assets/img/favicons/apple-icon-76x76.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="114x114"
      href="./src/assets/img/favicons/apple-icon-114x114.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="120x120"
      href="./src/assets/img/favicons/apple-icon-120x120.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="144x144"
      href="./src/assets/img/favicons/apple-icon-144x144.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="152x152"
      href="./src/assets/img/favicons/apple-icon-152x152.png"
    />
    <link
      rel="apple-touch-icon"
      sizes="180x180"
      href="./src/assets/img/favicons/apple-icon-180x180.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="192x192"
      href="./src/assets/img/favicons/android-icon-192x192.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
      href="./src/assets/img/favicons/favicon-32x32.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="96x96"
      href="./src/assets/img/favicons/favicon-96x96.png"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="./src/assets/img/favicons/favicon-16x16.png"
    />
    <link rel="manifest" href="./src/assets/img/favicons/manifest.json" />
    <meta name="msapplication-TileColor" content="#ffffff" />
    <meta
      name="msapplication-TileImage"
      content="./src/assets/img/favicons/ms-icon-144x144.png"
    />
...
============================== -->
          ...
          <div class="widget_shopping_cart_content">
            <ul class="cart_list">
              <li class="mini_cart_item">
                <a href="shop.html" class="remove"
                  ><i class="fal fa-trash-alt"></i
                ></a>
                <a href="shop.html"
                  ><img
                    src="./src/assets/img/cart/cart-img-1-1.jpg"
                    alt="Cart Image"
                  />Hot Burger</a
                >
                <span class="quantity"
              ...
              <li class="mini_cart_item">
                ...
                <a href="shop.html"
                  ><img
                    src="./src/assets/img/cart/cart-img-1-2.jpg"
                    alt="Cart Image"
                  />Vegetable</a
                >
                <span class="quantity"
              ...
              <li class="mini_cart_item">
                ...
                <a href="shop.html"
                  ><img
                    src="./src/assets/img/cart/cart-img-1-3.jpg"
                    alt="Cart Image"
                  />Pop Pizza</a
                >
                <span class="quantity"
              ...
              <li class="mini_cart_item">
                ...
                <a href="shop.html"
                  ><img
                    src="./src/assets/img/cart/cart-img-1-4.jpg"
                    alt="Cart Image"
                  />Onion & Tomato</a
                >
                <span class="quantity"
              ...
              <li class="mini_cart_item">
                ...
                <a href="shop.html"
                  ><img
                    src="./src/assets/img/cart/cart-img-1-5.jpg"
                    alt="Cart Image"
                  />Cool Drinks</a
                >
                <span class="quantity"
              ...
              <div class="header-infos">
                <p class="info">
                  <i class="fas fa-phone-alt"></i>Phone:<a
                    href="tel:02073885619"
                    >0846086806</a
                  >
                </p>
                <p class="info d-none d-md-inline-block">
                  <i class="fas fa-envelope"></i>Email:<a
                    href="mailto:devfsoft06@gmail.com"
                    >devfsoft06@gmail.com</a
                  >
                </p>
              </div>
            </div>
              ...
              <nav class="main-menu mobile-menu-active menu-style2">
                <ul>
                  ...
                  <li class="mega-menu-wrap menu-item-has-children">
                    <a href="#">Pages</a>
                    <ul class="mega-menu">
                      <li><a href="shop.html">Pagelist 1</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="contact.html">Contact Us</a>
    ...
    <div class="  ">
      <div
        ...
        data-globalbgimage="./src/assets/img/hero/hero-bg-6-1.jpg"
        data-height="810"
        data-container="1900"
      ...
      >
        ...
        >
          <img
            width="781"
            height="534"
            src="./src/assets/img/hero/hero-6-1.png"
          ...
          <img
            width="658"
            height="543"
            src="./src/assets/img/hero/hero-6-1-1.png"
          ...
          <img
            width="126"
            height="151"
            src="./src/assets/img/hero/hero-6-leaf-4.png"
            class="ls-l"
            alt="image"
            style="
              top: -300px;
          ...
          <img
            width="114"
            height="97"
            src="./src/assets/img/hero/hero-6-leaf-1.png"
            class="ls-l"
            alt="leaf"
            style="
              top: -300px;
          ...
          <img
            width="60"
            height="66"
            src="./src/assets/img/hero/hero-6-leaf-3.png"
            class="ls-l"
            alt="image"
            style="
              top: -300px;
          ...
          <img
            width="115"
            height="96"
            src="./src/assets/img/hero/hero-6-leaf-2.png"
            class="ls-l"
            alt="leaf"
            style="
              top: -300px;
        ...
        >
          <img
            width="687"
            height="554"
            src="./src/assets/img/hero/hero-6-1-2.png"
            class="ls-l ls-hide-tablet ls-hide-phone"
            alt="image"
            style="
              top: 215px;
        ...
        >
          <img
            width="639"
            height="536"
            src="./src/assets/img/hero/hero-6-1-3.png"
            class="ls-l ls-hide-tablet ls-hide-phone"
            alt="image"
            style="
              top: 215px;
        ...
        >
          <img
            width="627"
            height="537"
            src="./src/assets/img/hero/hero-6-1-4.png"
            class="ls-l ls-hide-tablet ls-hide-phone"
            alt="image"
            style="
              top: 215px;
        ...
        >
          <img
            width="649"
            height="537"
            src="./src/assets/img/hero/hero-6-1-5.png"
            class="ls-l ls-hide-tablet ls-hide-phone"
            alt="image"
            style="
              top: 215px;
        ...
        <div class="row vs-carousel" data-slide-show="3" id="catboxSlide4645">
          <div class="col-xl-4">
            <div class="cat-box">
              <div class="cat-box__img">
                <img
                  src="./src/assets/img/category/cat-1-1.png"
                  alt="Category image"
                />
              </div>
          ...
          <div class="col-xl-4">
            <div class="cat-box">
              <div class="cat-box__img">
                <img
                  src="./src/assets/img/category/cat-1-2.png"
                  alt="Category image"
                />
              </div>
              <h3 class="cat-box__title">
          ...
          <div class="col-xl-4">
            <div class="cat-box">
              <div class="cat-box__img">
                <img
                  src="./src/assets/img/category/cat-1-3.png"
                  alt="Category image"
                />
              </div>
              <h3 class="cat-box__title">
          ...
          <div class="col-xl-4">
            <div class="cat-box">
              <div class="cat-box__img">
                <img
                  src="./src/assets/img/category/cat-1-4.png"
                  alt="Category image"
                />
              </div>
              <h3 class="cat-box__title">
    ...
    <section
      ...
      data-bg-src="./src/assets/img/shape/bg-00778.png"
    >
      ...
      <div class="container position-relative">
        <div class="filter-menu2 vs-slideTab" data-asnavfor="#shopSlide8440">
          ...
          >
            <img
              src="./src/assets/img/shape/filter-icon-bg-1-2.png"
              alt="image"
              class="bg-1"
            />
            <img
              src="./src/assets/img/shape/filter-icon-bg-1-1.png"
              alt="image"
              class="bg-2"
            />
                ...
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-1.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-1.png"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-2.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-2.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-3.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag2">New</span
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-3.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-4.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-4.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-5.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-5.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-6.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-6.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-7.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-7.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-8.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-8.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-9.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-9.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-10.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag2">New</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-10.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-11.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-11.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-12.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-12.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-13.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-13.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-14.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-14.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-15.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-15.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-16.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-16.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-17.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-17.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-18.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-18.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-19.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-19.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-20.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-20.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-21.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-21.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-22.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag2">New</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-22.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-23.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-23.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-24.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-24.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-25.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-25.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-26.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-26.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-27.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-27.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-28.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-28.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-29.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-29.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-30.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-30.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-31.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag3">Sale</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-31.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="vs-product-box3">
                  <div class="product-img">
                    <a href="shop-details.html"
                      ><img
                        src="./src/assets/img/shop/product-3-32.png"
                        alt="Product Image"
                        class="w-100"
                    /></a>
                    <span class="product-tag1">Hot</span>
                  ...
                  <div class="actions-btn">
                    <a
                      href="./src/assets/img/shop/product-3-32.png"
                      class="icon-btn popup-image"
                      ><i class="far fa-search"></i
                    ></a>
                    <a href="wishlist.html" class="icon-btn"
          ...
          <div class="col-xl-4">
            <div class="package-style1">
              ...
              <div
                ...
                data-bg-src="./src/assets/img/shape/pack-bg.png"
              >
    ...
    <section class="space" data-bg-src="./src/assets/img/bg/newsletter-bg-1-2.jpg">
      <div class="container">
        <div
          ...
          data-bg-src="./src/assets/img/shape/newsletter-bg-1-1.png"
        >
            ...
            <div class="vs-blog blog-style1">
              <div class="blog-img image-scale-hover">
                <a href="blog-details.html"
                  ><img
                    src="./src/assets/img/blog/blog-4-1.jpg"
                    alt="Blog Image"
                    class="w-100"
                /></a>
              </div>
          ...
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img image-scale-hover">
                <a href="blog-details.html"
                  ><img
                    src="./src/assets/img/blog/blog-4-2.jpg"
                    alt="Blog Image"
                    class="w-100"
                /></a>
              </div>
          ...
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img image-scale-hover">
                <a href="blog-details.html"
                  ><img
                    src="./src/assets/img/blog/blog-4-3.jpg"
                    alt="Blog Image"
                    class="w-100"
                /></a>
              </div>
          ...
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img image-scale-hover">
                <a href="blog-details.html"
                  ><img
                    src="./src/assets/img/blog/blog-4-4.jpg"
                    alt="Blog Image"
                    class="w-100"
                /></a>
              </div>
      ...
      <div class="container-fluid">
        <div class="row gy-30">
          <div class="col-lg-4">
            <div
              class="banner-style1"
              data-bg-src="./src/assets/img/banner/banner-1-1.jpg"
            >
          ...
          <div class="col-lg-4">
            <div
              class="banner-style1"
              data-bg-src="./src/assets/img/banner/banner-1-2.jpg"
            >
              <div class="banner-content">
                <span class="banner-subtitle">End of season -50%</span>
          ...
          <div class="col-lg-4">
            <div
              class="banner-style1"
              data-bg-src="./src/assets/img/banner/banner-1-3.jpg"
            >
              <div class="banner-content">
                <span class="banner-subtitle">End of season -50%</span>
    ...
    <footer
      ...
      data-bg-src="./src/assets/img/shape/footer-5-1.jpg"
    >
      <div class="container">
              ...
              <div class="widget footer-widget">
                <div class="footer-info-widget">
                  <div class="footer-info-logo">
                    <img src="./src/assets/img/logo-white.svg" alt="FeeTech" />
                  </div>
              ...
              <div class="widget footer-widget">
                ...
                <div class="sidebar-gallery">
                  <div class="gallery-thumb">
                    <a class="popup-image" href="./src/assets/img/gallery/gal-2-1.jpg"
                      ><img
                        src="./src/assets/img/gallery/gal-2-1.jpg"
                        alt="Gallery Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="gallery-thumb">
                    <a class="popup-image" href="./src/assets/img/gallery/gal-2-2.jpg"
                      ><img
                        src="./src/assets/img/gallery/gal-2-2.jpg"
                        alt="Gallery Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="gallery-thumb">
                    <a class="popup-image" href="./src/assets/img/gallery/gal-2-3.jpg"
                      ><img
                        src="./src/assets/img/gallery/gal-2-3.jpg"
                        alt="Gallery Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="gallery-thumb">
                    <a class="popup-image" href="./src/assets/img/gallery/gal-2-4.jpg"
                      ><img
                        src="./src/assets/img/gallery/gal-2-4.jpg"
                        alt="Gallery Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="gallery-thumb">
                    <a class="popup-image" href="./src/assets/img/gallery/gal-2-5.jpg"
                      ><img
                        src="./src/assets/img/gallery/gal-2-5.jpg"
                        alt="Gallery Image"
                        class="w-100"
                    /></a>
                  </div>
                  <div class="gallery-thumb">
                    <a class="popup-image" href="./src/assets/img/gallery/gal-2-6.jpg"
                      ><img
                        src="./src/assets/img/gallery/gal-2-6.jpg"
                        alt="Gallery Image"
                        class="w-100"
                    /></a>
                  </div>
      ...
      <div class="copyright-area" data-bg-src="./src/assets/img/shape/footer-5-2.png">
        <div class="container">
