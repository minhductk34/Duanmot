...
<head>
	...
	<!-- Style -->
	<link rel="stylesheet" href="view/web/css/style.css" type="text/css" media="all">
...
<body>
		...
		<form action="index.php?controller=login" method="post">
			...
			<ul class="agileinfotickwthree">
				<li>
					...
					<a href="index.php?controller=forgot_password">Forgot password?</a>
				</li>
			</ul>
			<div class="aitssendbuttonw3ls">
				<input type="submit" value="LOGIN">
				<p> To register new account <span>→</span> <a class="w3_play_icon1" onclick="submitForm()" href="#small-dialog1"> Click Here</a></p>
				<div class="clear"></div>
			</div>
		</form>
	</div>
	...
	<!-- for register popup -->
	<div id="small-dialog1" class="mfp-hide" id="myForm">
		<div class="contact-form1">
			<div class="contact-w3-agileits">
				...
				<form action="index.php?controller=register" method="post">
					...
					<div class="form-sub-w3ls">
						<input placeholder="Confirm Password" type="password" required="" name="confirm">
						<div class="icon-agile">
							<i class="fa fa-unlock-alt" aria-hidden="true"></i>
						</div>
					</div>
