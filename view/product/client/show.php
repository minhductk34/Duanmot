...
<head>
    ...
    <title>FeeTech - Organic Food Store HTML Template - Shop</title>
        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-5 col-md-3">
                    <div class="logo">
                        <a href="index.html"><img src="./src/assets/img/logo.svg" alt="FeeTech"></a>
                    </div>
                </div>
                ...
                <div class="widget_shopping_cart_content">
                    <ul class="cart_list ">
                        <li class="mini_cart_item">
                            ...
                            <a href="shop.html"><img src="./src/assets/img/cart/cart-img-1-1.jpg" alt="Cart Image">Hot
                                Burger</a>
                        ...
                        <li class="mini_cart_item">
                            <a href="shop.html" class="remove"><i class="fal fa-trash-alt"></i></a>
                            <a href="shop.html"><img src="./src/assets/img/cart/cart-img-1-2.jpg"
                        ...
                        <li class="mini_cart_item">
                            <a href="shop.html" class="remove"><i class="fal fa-trash-alt"></i></a>
                            <a href="shop.html"><img src="./src/assets/img/cart/cart-img-1-3.jpg" alt="Cart Image">Pop
                                Pizza</a>
                            <span class="quantity">1 ×
                                <span class="amount">
                                    <span>$</span>56.00
                        ...
                        <li class="mini_cart_item">
                            <a href="shop.html" class="remove"><i class="fal fa-trash-alt"></i></a>
                            <a href="shop.html"><img src="./src/assets/img/cart/cart-img-1-4.jpg" alt="Cart Image">Onion &
                                Tomato</a>
                            <span class="quantity">1 ×
                                <span class="amount">
                                    <span>$</span>23.00
                        ...
                        <li class="mini_cart_item">
                            <a href="shop.html" class="remove"><i class="fal fa-trash-alt"></i></a>
                            <a href="shop.html"><img src="./src/assets/img/cart/cart-img-1-5.jpg" alt="Cart Image">Cool
                                Drinks</a>
                            <span class="quantity">1 ×
                                <span class="amount">
                                    <span>$</span>100.00
            ...
            <div class="row">
                <div class="col-lg-8 col-xl-9">
                    <div
                        ...
                        <div class="col-auto mb-3 mb-sm-0">
                            <div class="nav" permissions="tablist">
                                <a href="shop.html" class="icon-btn style3 active me-2" id="tab-shop-grid"
                                    data-bs-toggle="tab" data-bs-target="#tab-grid" permissions="tab" aria-controls="tab-grid"
                                    aria-selected="true"><i class="fas fa-th"></i></a>
                                <a href="shop-list.html" class="icon-btn style3  " id="tab-shop-list"
                                    data-bs-toggle="tab" data-bs-target="#tab-list" permissions="tab" aria-controls="tab-grid"
                                    aria-selected="false"><i class="far fa-bars"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="tab-grid" permissions="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-1.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-8.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-1.png" class="popup-image"><i
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-2.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-7.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-2.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-3.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-6.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-3.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        <div class="product-tag1">sale</div>
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-4.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-5.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-4.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-5.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-6.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-7.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-8.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        <div class="product-tag1">sale</div>
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-9.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-1-6.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content">
                                            <div class="actions-btn">
                                                <a href="cart.html"><i class="fal fa-cart-plus"></i></a>
                                                <a href="./src/assets/img/shop/product-1-9.png" class="popup-image"><i
                                                        class="far fa-search"></i></a>
                                                <a href="wishlist.html"><i class="fal fa-heart"></i></a>
                                            </div>
                            ...
                            <div class="row ">
                                <div class="col-sm-6 col-lg-6 col-xl-6">
                                    <div class="vs-product-box2 d-xl-flex has-border thumb_swap">
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-1.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-8.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-6">
                                    <div class="vs-product-box2 d-xl-flex has-border thumb_swap">
                                        <div class="product-tag1">sale</div>
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-2.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-7.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content d-xl-flex align-items-center">
                                            <div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-6">
                                    <div class="vs-product-box2 d-xl-flex has-border thumb_swap">
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-3.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-6.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content d-xl-flex align-items-center">
                                            <div>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-6">
                                    <div class="vs-product-box2 d-xl-flex has-border thumb_swap">
                                        <div class="product-img">
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-4.png"
                                                    alt="Product Image" class="w-100"></a>
                                            <a href="shop-details.html"><img src="./src/assets/img/shop/product-2-5.png"
                                                    alt="Product Image" class="w-100 img_swap"></a>
                                        </div>
                                        <div class="product-content d-xl-flex align-items-center">
                                            <div>
                                        ...
                                        <div class="product-content d-xl-flex align-items-center">
                                            <div>
                                                <h4 class="product-title h5 mb-1"><a
                                                        href="shop-details.html">Quesadilla</a></h4>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-6">
                                    <div class="vs-product-box2 d-xl-flex has-border thumb_swap">
                                        ...
                                        <div class="product-content d-xl-flex align-items-center">
                                            <div>
                                                <h4 class="product-title h5 mb-1"><a
                                                        href="shop-details.html">Pepperoni</a></h4>
                                ...
                                <div class="col-sm-6 col-lg-6 col-xl-6">
                                    <div class="vs-product-box2 d-xl-flex has-border thumb_swap">
                                        ...
                                        <div class="product-content d-xl-flex align-items-center">
                                            <div>
                                                <h4 class="product-title h5 mb-1"><a
                                                        href="shop-details.html">Meatballs</a></h4>
                        ...
                        <div class="widget   ">
                            ...
                            <div class="vs-widget-recent-post">
                                <div class="recent-post d-flex align-items-center">
                                    <div class="media-img">
                                        <img src="./src/assets/img/widget/recent-1.jpg" width="100" height="73"
                                ...
                                <div class="recent-post d-flex align-items-center">
                                    <div class="media-img">
                                        <img src="./src/assets/img/widget/recent-2.jpg" width="100" height="73"
                                            alt="Recent Post Image">
                                    </div>
                                    <div class="media-body pl-30">
                                ...
                                <div class="recent-post d-flex align-items-center">
                                    <div class="media-img">
                                        <img src="./src/assets/img/widget/recent-3.jpg" width="100" height="73"
                                            alt="Recent Post Image">
                                    </div>
                                    <div class="media-body pl-30">
        ...
        <footer class="footer-wrapper footer-layout1">
            <div class="container">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="widget footer-widget  ">
                                ...
                                <div class="vs-widget-about">
                                    <p class="fs-md">6Fifth Avenue 5501, Broadway, New York Morris Street <br> London
                                        1234</p>
                                    <p class="mb-1 link-inherit"><i class="fas fa-paper-plane me-3"></i><a
                                            href="mailto:foodano@example.com">foodano@example.com</a></p>
                                    <p class="mb-0 link-inherit"><i class="fal fa-fax me-3"></i><a
                                            href="tel:+123456789000">+(123) 4567 89000</a></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget  footer-widget  ">
                                ...
                                <div class="footer-social-links">
                                    <ul>
                                        ...
                                        <li><a href="htttps://google.com"><i
                                                    class="fal fa-basketball-ball"></i>dribvble</a></li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-4">
                            ...
                            <div class="widget footer-widget   ">
                                ...
                                <div class="footer-map pt-1">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d193595.1583088354!2d-74.11976389828038!3d40.697663748695746!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sbd!4v1612886249367!5m2!1sen!2sbd"
                ...
                <div class="copyright text-center pb-35">
                    <p class="mb-0 link-inherit">Copyright &copy; 2022 <a href="index.html">FeeTech</a> - All Rights
                        Reserved by <a href="https://themeforest.net/user/vecuro_themes"></a></p>
                </div>
            </div>
        </footer>
    </div>
